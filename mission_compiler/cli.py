...
from mission_compiler.artifacts.bundle import compile_bundle, validate_mission
from mission_compiler.io import read_json
from mission_compiler.ir.canonicalize import canonicalize
from mission_compiler.runtime.run_python import run_generated_python
from mission_compiler.dependencies.spice import write_spice_requests, resolve_spice_request
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="python -m mission_compiler")
